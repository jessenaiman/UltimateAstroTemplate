...
test.describe("Theme System", () => {
  ...
  test("should toggle theme when clicking theme button", async ({ page }) => {
    ...
    await expect(page.locator("#theme-toggle-light-icon")).not.toHaveClass(
      /hidden/,
    );
    ...
    // Icons should update
    await expect(page.locator("#theme-toggle-light-icon")).toHaveClass(
      /hidden/,
    );
    await expect(page.locator("#theme-toggle-dark-icon")).not.toHaveClass(
      /hidden/,
    );
  });
