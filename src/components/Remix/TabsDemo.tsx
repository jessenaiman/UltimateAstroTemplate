  ...
  return (
    <div className="w-full">
      <div role="tablist" className="tabs tabs-bordered">
        ...
        <div
          role="tabpanel"
          className={`tab-content p-5 ${activeTab === "tab1" ? "block" : "hidden"}`}
        >
        ...
        <div
          role="tabpanel"
          className={`tab-content p-5 ${activeTab === "tab2" ? "block" : "hidden"}`}
        >
          <p className="text-base-content/70">
        ...
        <div
          role="tabpanel"
          className={`tab-content p-5 ${activeTab === "tab3" ? "block" : "hidden"}`}
        >
          <p className="text-base-content/70">
