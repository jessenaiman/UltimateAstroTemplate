<template>
  <section
    class="min-h-[80vh] flex items-center justify-center text-white px-8 py-12 mt-24"
  >
        ...
        <div class="text-left space-y-6">
          ...
          >
            ...
            >
              ...
              <span class="text-4xl md:text-5xl"
                >Where Innovation Meets Speed</span
              >
            </h1>
          </Transition>
          ...
          >
            <p class="text-xl text-gray-300 leading-relaxed">
              Experience the perfect blend of Vue's reactivity and Astro's
              performance. Build faster, smoother, and more engaging web
              applications.
            </p>
          </Transition>
        ...
        <div class="relative">
          ...
          >
            <div class="relative">
              <!-- Demo Container -->
              <div
                class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 shadow-xl"
              >
                <div class="absolute">
...
const scrollToFeatures = () => {
  ...
  if (features) {
    ...
    const y =
      features.getBoundingClientRect().top + window.pageYOffset + yOffset;
